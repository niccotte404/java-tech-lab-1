...
public class BankServiceImpl implements BankService {
    ...
    public Transaction makeTransaction(Transaction transaction) {
        ...
        actionMap.put(TransactionType.TRANSFER, new WithdrawCommand(transaction).execute());
        actionMap.put(TransactionType.REPLENISH, new ReplenishCommand(transaction).execute());
        actionMap.put(TransactionType.WITHDRAW, new TransferCommand(transaction).execute());
